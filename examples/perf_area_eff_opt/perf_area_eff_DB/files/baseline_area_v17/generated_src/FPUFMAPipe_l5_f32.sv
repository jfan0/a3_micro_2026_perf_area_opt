...
module FPUFMAPipe_l5_f32(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    if (_fma_io_validout) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:719:19]
      io_out_pipe_b_data <= {32'h0, _fma_io_out};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:711:50, :719:19, :729:12, src/main/scala/chisel3/util/Valid.scala:142:26]
    ...
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    else begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    logic [31:0] _RANDOM[0:11];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
        ...
        io_out_pipe_pipe_v = _RANDOM[4'h9][7];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26]
        io_out_pipe_pipe_b_data = {_RANDOM[4'h9][31:8], _RANDOM[4'hA], _RANDOM[4'hB][8:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        io_out_pipe_pipe_b_exc = _RANDOM[4'hB][13:9];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:142:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_valid = io_out_pipe_pipe_v;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:141:24]
  assign io_out_bits_data = io_out_pipe_pipe_b_data;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:142:26]
  assign io_out_bits_exc = io_out_pipe_pipe_b_exc;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, src/main/scala/chisel3/util/Valid.scala:142:26]
endmodule
