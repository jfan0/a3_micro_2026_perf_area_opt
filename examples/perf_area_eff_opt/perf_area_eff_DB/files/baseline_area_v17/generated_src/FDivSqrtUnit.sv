...
module FDivSqrtUnit(	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
    ...
    logic [31:0] _RANDOM[0:59];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
    initial begin	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
        ...
        r_buffer_req_uop_rob_idx = _RANDOM[6'h6][27:22];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_pdst = _RANDOM[6'h7][12:6];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_is_amo = _RANDOM[6'hA][30];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_uses_ldq = _RANDOM[6'hA][31];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_uses_stq = _RANDOM[6'hB][0];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_dst_rtype = _RANDOM[6'hB][31:30];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_fp_val = _RANDOM[6'hC][5];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_fin_typeTagIn = _RANDOM[6'h12][29:28];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_div = _RANDOM[6'h13][4];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_sqrt = _RANDOM[6'h13][5];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_rm = _RANDOM[6'h13][10:8];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_in1 = {_RANDOM[6'h13][31:17], _RANDOM[6'h14], _RANDOM[6'h15][17:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_in2 = {_RANDOM[6'h15][31:18], _RANDOM[6'h16], _RANDOM[6'h17][18:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_divsqrt_val = _RANDOM[6'h19][20];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30]
        r_divsqrt_killed = _RANDOM[6'h19][21];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :146:29]
        r_divsqrt_fin_typeTagIn = _RANDOM[6'h19][30:29];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :147:26]
        r_divsqrt_fin_rm = _RANDOM[6'h1A][11:9];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :147:26]
        r_divsqrt_uop_br_mask = _RANDOM[6'h25][25:18];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_rob_idx = _RANDOM[6'h27][15:10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_pdst = {_RANDOM[6'h27][31:26], _RANDOM[6'h28][0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_is_amo = _RANDOM[6'h2B][18];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_uses_ldq = _RANDOM[6'h2B][19];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_uses_stq = _RANDOM[6'h2B][20];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_dst_rtype = _RANDOM[6'h2C][19:18];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_fp_val = _RANDOM[6'h2C][25];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_out_val = _RANDOM[6'h2D][4];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :184:26]
        r_out_uop_br_mask = _RANDOM[6'h32][9:2];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_rob_idx = _RANDOM[6'h33][31:26];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_pdst = _RANDOM[6'h34][16:10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_is_amo = _RANDOM[6'h38][2];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_uses_ldq = _RANDOM[6'h38][3];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_uses_stq = _RANDOM[6'h38][4];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_dst_rtype = _RANDOM[6'h39][3:2];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_fp_val = _RANDOM[6'h39][9];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_flags_double = _RANDOM[6'h39][24:20];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22, :186:31]
        r_out_wdata_double = {_RANDOM[6'h39][31:25], _RANDOM[6'h3A], _RANDOM[6'h3B][25:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22, :187:31]
      `endif // RANDOMIZE_REG_INIT
    end // initial
