...
module Queue2_BranchPredictionUpdate(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [79:0] io_enq_bits_meta_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [39:0] io_deq_bits_target,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [79:0] io_deq_bits_meta_0	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
);

  wire         io_enq_ready;	// @[src/main/scala/chisel3/util/Decoupled.scala:286:19]
  wire [240:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x241 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_meta_0, 40'h0, io_enq_bits_ghist_old_history, 11'h0, io_enq_bits_pc, io_enq_bits_btb_mispredicts, 2'h0})	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14, :256:91]
  ...
  assign io_deq_bits_is_mispredict_update = _ram_ext_R0_data[0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_is_repair_update = _ram_ext_R0_data[1];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_btb_mispredicts = _ram_ext_R0_data[5:2];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_pc = _ram_ext_R0_data[45:6];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_br_mask = _ram_ext_R0_data[49:46];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_idx_valid = _ram_ext_R0_data[50];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_idx_bits = _ram_ext_R0_data[52:51];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_taken = _ram_ext_R0_data[53];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_mispredicted = _ram_ext_R0_data[54];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_is_br = _ram_ext_R0_data[55];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cfi_is_jal = _ram_ext_R0_data[56];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_ghist_old_history = _ram_ext_R0_data[120:57];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_target = _ram_ext_R0_data[160:121];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_meta_0 = _ram_ext_R0_data[240:161];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
