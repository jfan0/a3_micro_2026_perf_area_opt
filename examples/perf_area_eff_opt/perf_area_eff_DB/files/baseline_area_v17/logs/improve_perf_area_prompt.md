...
**The parent design you are improving — branch `baseline_area_v16`:**

| metric | value |
|---|---|
| total cell area | 5,024,660 um2 |
| embench speed score | 114.814 |
| embench speed per MHz | 2.192370 |
| mean embench IPC | 1.428141 (reported, not the objective) |
| fmax | 52.37 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 22.850188 speed/mm2 |

**The bar you have to clear is not that last row.** It is `22.850188 speed/mm2`, reached
by branch `v16` — the best figure any branch in the tree has measured,
and what the gate compares you against.

Usually `v16` *is* the parent and the two are the same number. When
...
| branch | built on | area mm2 | fmax MHz | IPC | speed/MHz | speed/mm2 | status | files this step touched |
|---|---|---|---|---|---|---|---|---|
| v17 | v16 | n/a | n/a | n/a | n/a | n/a | n/a | -- |
...
1. **`perf_area_eff` must exceed `22.850188 speed/mm2`** — the best any branch has
   measured (`v16`), not the parent's figure. Strictly exceed:
...
`parent_eff x (your ratio) > 22.850188 speed/mm2`, so work out that gap in percent first
...
The same three files for each of: v15_timing, v15_1_synth_only_flatten, v15_1, v15_synth_only_flatten, seed_synth_only_flatten — the most recent
