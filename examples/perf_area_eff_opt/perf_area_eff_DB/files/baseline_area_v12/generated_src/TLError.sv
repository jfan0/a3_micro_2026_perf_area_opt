...
module TLError(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
  ...
  reg  [2:0]  casez_tmp;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:38:21]
  ...
  wire [26:0] _GEN = {23'h0, _a_q_io_deq_bits_size};	// @[generators/rocket-chip/src/main/scala/util/package.scala:244:71, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [26:0] _a_last_beats1_decode_T = 27'hFFF << _GEN;	// @[generators/rocket-chip/src/main/scala/util/package.scala:244:71]
  ...
  wire [26:0] _r_beats1_decode_T = 27'hFFF << _GEN;	// @[generators/rocket-chip/src/main/scala/util/package.scala:244:71]
  wire [8:0]  r_beats1 = casez_tmp[0] ? ~(_r_beats1_decode_T[11:3]) : 9'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:38:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:244:{46,71,76}]
  ...
  always @(*) begin
    casez (_a_q_io_deq_bits_opcode)	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
      3'b000:
        casez_tmp = 3'h0;
      3'b001:
        casez_tmp = 3'h0;
      ...
      default:
        casez_tmp = 3'h4;
    endcase	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  end // always @(*)
  ...
  TLMonitor_19 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_bits_opcode  (casez_tmp),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:38:21]
    ...
    .io_in_d_bits_corrupt (casez_tmp[0])	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:38:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36]
  ...
  assign auto_in_d_bits_opcode = casez_tmp;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, :38:21]
  ...
  assign auto_in_d_bits_corrupt = casez_tmp[0];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9, :38:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36]
endmodule
