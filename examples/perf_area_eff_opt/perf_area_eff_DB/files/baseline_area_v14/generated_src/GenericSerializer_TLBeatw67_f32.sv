...
module GenericSerializer_TLBeatw67_f32(	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
  ...
  wire [2:0]  _GEN = {io_in_valid, beat};	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:20:21, :23:{31,39}]
  reg  [31:0] casez_tmp;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:24:26]
  always @(*) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:24:26]
    casez (beat)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:20:21, :24:26]
      2'b00:
        casez_tmp = 32'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :24:26]
      2'b01:
        casez_tmp = data_1;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :24:26]
      2'b10:
        casez_tmp = data_2;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :24:26]
      default:
        casez_tmp = 32'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:24:26]
    endcase	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:20:21, :24:26]
  end // always @(*)
  wire        _GEN_0 = io_out_ready & (|_GEN);	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:23:{31,39}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
    if (_GEN_0 & _io_out_bits_flit_T) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :22:39, :26:22, :28:25, :29:12, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  assign io_out_valid = |_GEN;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :23:{31,39}]
  assign io_out_bits_flit = _io_out_bits_flit_T ? {io_in_bits_payload[29:0], io_in_bits_head, io_in_bits_tail} : casez_tmp;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :22:39, :24:{26,52}]
endmodule
