...
**The parent design you are improving — branch `baseline_area_v13`:**

| metric | value |
|---|---|
| total cell area | 5,305,560 um2 |
| embench speed score | 105.861 |
| embench speed per MHz | 2.197645 |
| mean embench IPC | 1.432266 (reported, not the objective) |
| fmax | 48.17 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 19.952759 speed/mm2 |

**The bar you have to clear is not that last row.** It is `19.952759 speed/mm2`, reached
by branch `v13` — the best figure any branch in the tree has measured,
and what the gate compares you against.

Usually `v13` *is* the parent and the two are the same number. When
...
| branch | built on | area mm2 | fmax MHz | IPC | speed/MHz | speed/mm2 | status | files this step touched |
|---|---|---|---|---|---|---|---|---|
| v14 | v13 | n/a | n/a | n/a | n/a | n/a | n/a | -- |
...
1. **`perf_area_eff` must exceed `19.952759 speed/mm2`** — the best any branch has
   measured (`v13`), not the parent's figure. Strictly exceed:
...
`parent_eff x (your ratio) > 19.952759 speed/mm2`, so work out that gap in percent first
...
The same three files for each of: v12, v11, v10_synth_only_flatten, v10_1, v10_synth_only — the most recent
