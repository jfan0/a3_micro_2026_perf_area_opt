...
module BranchKillableQueue_5(	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
  ...
  always @(posedge clock) begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    if (reset) begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
      ...
      valids_0 <= ~(do_deq & deq_ptr_value == 2'h0) & (_GEN_0 | valids_0 & (io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 12'h0 & ~io_flush);	// @[generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}, :465:24, :466:20, :476:{24,66}, :481:{16,29,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14, src/main/scala/chisel3/util/Counter.scala:61:40]
      valids_1 <= ~(do_deq & deq_ptr_value == 2'h1) & (_GEN_2 | valids_1 & (io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 12'h0 & ~io_flush);	// @[generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}, :465:24, :466:20, :476:{24,66}, :481:{16,29,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14, src/main/scala/chisel3/util/Counter.scala:61:40]
      valids_2 <= ~(do_deq & deq_ptr_value == 2'h2) & (_GEN_4 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 12'h0 & ~io_flush);	// @[generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}, :465:24, :466:20, :476:{24,66}, :481:{16,29,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14, src/main/scala/chisel3/util/Counter.scala:61:40]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    ...
    logic [31:0] _RANDOM[0:38];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    initial begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
        ...
        uops_0_br_mask = _RANDOM[6'h5][11:0];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_rob_idx = {_RANDOM[6'h6][31:29], _RANDOM[6'h7][2:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_stq_idx = _RANDOM[6'h7][10:7];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_pdst = _RANDOM[6'h7][19:13];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_is_amo = _RANDOM[6'hB][5];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_uses_stq = _RANDOM[6'hB][7];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_dst_rtype = _RANDOM[6'hC][6:5];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_fp_val = _RANDOM[6'hC][12];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_uopc = _RANDOM[6'hC][29:23];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_br_mask = _RANDOM[6'h11][31:20];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_rob_idx = _RANDOM[6'h13][22:17];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_stq_idx = _RANDOM[6'h13][30:27];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_pdst = _RANDOM[6'h14][7:1];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_is_amo = _RANDOM[6'h17][25];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_uses_stq = _RANDOM[6'h17][27];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_dst_rtype = _RANDOM[6'h18][26:25];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_fp_val = _RANDOM[6'h19][0];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_uopc = _RANDOM[6'h19][17:11];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_br_mask = _RANDOM[6'h1E][19:8];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_rob_idx = _RANDOM[6'h20][10:5];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_stq_idx = _RANDOM[6'h20][18:15];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_pdst = _RANDOM[6'h20][27:21];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_is_amo = _RANDOM[6'h24][13];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_uses_stq = _RANDOM[6'h24][15];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_dst_rtype = _RANDOM[6'h25][14:13];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_fp_val = _RANDOM[6'h25][20];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        enq_ptr_value = {_RANDOM[6'h25][31], _RANDOM[6'h26][0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[6'h26][2:1];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[6'h26][3];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :470:27, src/main/scala/chisel3/util/Counter.scala:61:40]
      `endif // RANDOMIZE_REG_INIT
    end // initial
