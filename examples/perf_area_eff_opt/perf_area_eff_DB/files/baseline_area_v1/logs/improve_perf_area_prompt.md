...
**The parent design you are improving — branch `baseline`:**

| metric | value |
|---|---|
| total cell area | 8,435,057 um2 |
| embench speed score | 100.316 |
| embench speed per MHz | 2.229238 |
| mean embench IPC | 1.449806 (reported, not the objective) |
| fmax | 45.0 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 11.892713 speed/mm2 |
