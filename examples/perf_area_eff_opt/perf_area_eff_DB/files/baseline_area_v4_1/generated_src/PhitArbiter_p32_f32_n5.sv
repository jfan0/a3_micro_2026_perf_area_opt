...
module PhitArbiter_p32_f32_n5(	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:148:7]
  ...
  reg         casez_tmp;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
  always @(*) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
    casez (chosen)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:164:21, :167:18]
      3'b000:
        casez_tmp = io_in_0_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
      3'b001:
        casez_tmp = io_in_1_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
      3'b010:
        casez_tmp = io_in_2_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
      3'b011:
        casez_tmp = io_in_3_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
      3'b100:
        casez_tmp = io_in_4_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
      3'b101:
        casez_tmp = io_in_0_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
      3'b110:
        casez_tmp = io_in_0_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
      default:
        casez_tmp = io_in_0_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18]
    endcase	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:164:21, :167:18]
  end // always @(*)
  reg  [31:0] casez_tmp_0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
  always @(*) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
    casez (chosen)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:164:21, :168:28]
      3'b000:
        casez_tmp_0 = io_in_0_bits_phit;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
      3'b001:
        casez_tmp_0 = io_in_1_bits_phit;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
      3'b010:
        casez_tmp_0 = io_in_2_bits_phit;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
      3'b011:
        casez_tmp_0 = io_in_3_bits_phit;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
      3'b100:
        casez_tmp_0 = io_in_4_bits_phit;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
      3'b101:
        casez_tmp_0 = io_in_0_bits_phit;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
      3'b110:
        casez_tmp_0 = io_in_0_bits_phit;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
      default:
        casez_tmp_0 = io_in_0_bits_phit;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:168:28]
    endcase	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:164:21, :168:28]
  end // always @(*)
  wire        _GEN = io_out_ready & casez_tmp;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:167:18, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:148:7]
    ...
    if (_GEN & ~beat)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:161:23, :162:25, :164:27, :176:24, :178:{27,40}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  assign io_out_valid = casez_tmp;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:148:7, :167:18]
  assign io_out_bits_phit = beat ? casez_tmp_0 : {29'h0, chosen};	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:148:7, :161:23, :164:21, :168:28, :169:22]
endmodule
