...
module PipelinedMultiplier(	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7]
    ...
    if (in_pipe_v)	// @[src/main/scala/chisel3/util/Valid.scala:141:24]
      io_resp_bits_data_pipe_b <= (|{in_pipe_b_fn[0], in_pipe_b_fn[1]}) ? prod[127:64] : in_pipe_b_dw ? prod[63:0] : {{32{prod[31]}}, prod[31:0]};	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:205:18, :206:{18,30,53,67,101}, generators/rocket-chip/src/main/scala/util/package.scala:133:{15,20,38}, src/main/scala/chisel3/util/Valid.scala:142:26, src/main/scala/chisel3/util/pla.scala:90:45, :114:{19,36}]
