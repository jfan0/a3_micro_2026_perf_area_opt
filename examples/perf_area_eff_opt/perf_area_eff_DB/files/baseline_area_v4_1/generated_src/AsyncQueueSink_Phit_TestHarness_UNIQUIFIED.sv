...
module AsyncQueueSink_Phit_TestHarness_UNIQUIFIED(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7]
  ...
  reg  [31:0] casez_tmp;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
  always @(*) begin	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
    casez (_index_T ^ {ridx_incremented[3], 2'h0})	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:53:23, :54:17, :156:{55,75}, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
      3'b000:
        casez_tmp = io_async_mem_0_phit;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
      3'b001:
        casez_tmp = io_async_mem_1_phit;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
      3'b010:
        casez_tmp = io_async_mem_2_phit;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
      3'b011:
        casez_tmp = io_async_mem_3_phit;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
      3'b100:
        casez_tmp = io_async_mem_4_phit;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
      3'b101:
        casez_tmp = io_async_mem_5_phit;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
      3'b110:
        casez_tmp = io_async_mem_6_phit;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
      default:
        casez_tmp = io_async_mem_7_phit;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
    endcase	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:53:23, :54:17, :156:{55,75}, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
  end // always @(*)
  ...
  ClockCrossingReg_w32_TestHarness_UNIQUIFIED io_deq_bits_deq_bits_reg(	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  (casez_tmp),	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
