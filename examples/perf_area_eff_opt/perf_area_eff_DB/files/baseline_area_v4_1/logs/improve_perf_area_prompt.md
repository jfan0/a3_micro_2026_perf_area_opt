...
**The parent design you are improving — branch `baseline_area_v3`:**

| metric | value |
|---|---|
| total cell area | 6,547,595 um2 |
| embench speed score | 106.486 |
| embench speed per MHz | 2.224019 |
| mean embench IPC | 1.446213 (reported, not the objective) |
| fmax | 47.88 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 16.263380 speed/mm2 |
