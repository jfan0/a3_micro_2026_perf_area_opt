...
**The parent design you are improving — branch `baseline_area_v8`:**

| metric | value |
|---|---|
| total cell area | 5,473,384 um2 |
| embench speed score | 102.828 |
| embench speed per MHz | 2.197645 |
| mean embench IPC | 1.432266 (reported, not the objective) |
| fmax | 46.79 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 18.786882 speed/mm2 |
