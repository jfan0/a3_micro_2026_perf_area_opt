...
module FDivSqrtUnit(	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
  ...
  wire        _divsqrt_io_inReady;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:143:23]
  ...
  reg  [11:0] r_buffer_req_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:98:25]
  reg  [5:0]  r_buffer_req_uop_rob_idx;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:98:25]
  ...
  reg  [11:0] r_divsqrt_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:148:26]
  reg  [5:0]  r_divsqrt_uop_rob_idx;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:148:26]
  ...
  reg  [11:0] r_out_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:185:22]
  reg  [5:0]  r_out_uop_rob_idx;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:185:22]
  ...
  wire [11:0] _io_resp_valid_T = io_brupdate_b1_mispredict_mask & r_out_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:185:22, generators/boom/src/main/scala/v3/util/util.scala:118:51]
  ...
  wire        io_resp_valid_0 = r_out_val & _io_resp_valid_T == 12'h0;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:184:26, :218:30, generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}]
  ...
  wire [11:0] _r_divsqrt_killed_T_4 = io_brupdate_b1_mispredict_mask & r_buffer_req_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:98:25, generators/boom/src/main/scala/v3/util/util.scala:118:51]
  wire        _GEN_1 = io_req_valid & (io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask) == 12'h0 & ~io_req_bits_kill;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:105:71, :121:{22,73}, generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}]
  wire [11:0] _r_out_val_T_1 = io_brupdate_b1_mispredict_mask & r_divsqrt_uop_br_mask;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:148:26, generators/boom/src/main/scala/v3/util/util.scala:118:51]
  wire        _GEN_2 = divsqrt_io_inValid & _divsqrt_io_inReady;	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:143:23, :154:18, :155:45, :156:20, :170:24]
  always @(posedge clock) begin	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
    if (reset) begin	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
      ...
      r_buffer_val <= ~_GEN_2 & (_GEN_1 | _r_divsqrt_killed_T_4 == 12'h0 & ~io_req_bits_kill & r_buffer_val);	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:97:29, :105:{16,68,71,89}, :121:{22,73,95}, :122:18, :170:{24,42}, :173:18, generators/boom/src/main/scala/v3/util/util.scala:118:{51,59}]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
    ...
    logic [31:0] _RANDOM[0:60];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
    initial begin	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
        ...
        r_buffer_req_uop_br_mask = {_RANDOM[6'h4][31:30], _RANDOM[6'h5][9:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_rob_idx = {_RANDOM[6'h6][31:27], _RANDOM[6'h7][0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_pdst = _RANDOM[6'h7][17:11];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_is_amo = _RANDOM[6'hB][3];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_uses_ldq = _RANDOM[6'hB][4];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_uses_stq = _RANDOM[6'hB][5];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_dst_rtype = _RANDOM[6'hC][4:3];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_fp_val = _RANDOM[6'hC][10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_fin_typeTagIn = _RANDOM[6'h13][2:1];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_div = _RANDOM[6'h13][9];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_sqrt = _RANDOM[6'h13][10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_rm = _RANDOM[6'h13][15:13];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_in1 = {_RANDOM[6'h13][31:22], _RANDOM[6'h14], _RANDOM[6'h15][22:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_in2 = {_RANDOM[6'h15][31:23], _RANDOM[6'h16], _RANDOM[6'h17][23:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_divsqrt_val = _RANDOM[6'h19][25];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30]
        r_divsqrt_killed = _RANDOM[6'h19][26];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :146:29]
        r_divsqrt_fin_typeTagIn = _RANDOM[6'h1A][3:2];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :147:26]
        r_divsqrt_fin_rm = _RANDOM[6'h1A][16:14];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :147:26]
        r_divsqrt_uop_br_mask = {_RANDOM[6'h25][31:23], _RANDOM[6'h26][2:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_rob_idx = _RANDOM[6'h27][25:20];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_pdst = _RANDOM[6'h28][10:4];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_is_amo = _RANDOM[6'h2B][28];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_uses_ldq = _RANDOM[6'h2B][29];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_uses_stq = _RANDOM[6'h2B][30];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_dst_rtype = _RANDOM[6'h2C][29:28];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_fp_val = _RANDOM[6'h2D][3];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_out_val = _RANDOM[6'h2D][14];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26, :184:26]
        r_out_uop_br_mask = _RANDOM[6'h32][23:12];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_rob_idx = _RANDOM[6'h34][14:9];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_pdst = _RANDOM[6'h34][31:25];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_is_amo = _RANDOM[6'h38][17];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_uses_ldq = _RANDOM[6'h38][18];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_uses_stq = _RANDOM[6'h38][19];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_dst_rtype = _RANDOM[6'h39][18:17];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_fp_val = _RANDOM[6'h39][24];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_flags_double = _RANDOM[6'h3A][7:3];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :186:31]
        r_out_wdata_double = {_RANDOM[6'h3A][31:8], _RANDOM[6'h3B], _RANDOM[6'h3C][8:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :186:31, :187:31]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  DivSqrtRecFM_small_e11_s53 divsqrt (	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:143:23]
    .clock             (clock),
    .reset             (reset),
