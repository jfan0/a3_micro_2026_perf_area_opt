...
**The parent design you are improving — branch `baseline_area_v14`:**

| metric | value |
|---|---|
| total cell area | 5,136,254 um2 |
| embench speed score | 105.660 |
| embench speed per MHz | 2.193479 |
| mean embench IPC | 1.428717 (reported, not the objective) |
| fmax | 48.17 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 20.571389 speed/mm2 |
...
| v15_1 | v14 | n/a | n/a | n/a | n/a | n/a | n/a | -- |
...
The same three files for each of: v15_synth_only_flatten, seed_synth_only_flatten, v15, v13, v12 — the most recent
