...
module FPToFP(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
  ...
  reg  [64:0] io_out_pipe_pipe_pipe_pipe_b_data;	// @[src/main/scala/chisel3/util/Valid.scala:142:26]
  reg  [4:0]  io_out_pipe_pipe_pipe_pipe_b_exc;	// @[src/main/scala/chisel3/util/Valid.scala:142:26]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
    ...
    if (io_out_pipe_pipe_pipe_v) begin	// @[src/main/scala/chisel3/util/Valid.scala:141:24]
      ...
      io_out_pipe_pipe_pipe_pipe_b_exc <= io_out_pipe_pipe_pipe_b_exc;	// @[src/main/scala/chisel3/util/Valid.scala:142:26]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
    ...
    logic [31:0] _RANDOM[0:15];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
        for (logic [4:0] i = 5'h0; i < 5'h10; i += 5'h1) begin
          _RANDOM[i[3:0]] = `RANDOM;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
        ...
        io_out_pipe_pipe_pipe_pipe_v = _RANDOM[4'hD][21];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26]
        io_out_pipe_pipe_pipe_pipe_b_data = {_RANDOM[4'hD][31:22], _RANDOM[4'hE], _RANDOM[4'hF][22:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        io_out_pipe_pipe_pipe_pipe_b_exc = _RANDOM[4'hF][27:23];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_valid = io_out_pipe_pipe_pipe_pipe_v;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:141:24]
  assign io_out_bits_data = io_out_pipe_pipe_pipe_pipe_b_data;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26]
  assign io_out_bits_exc = io_out_pipe_pipe_pipe_pipe_b_exc;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26]
endmodule
