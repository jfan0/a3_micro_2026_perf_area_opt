...
module regfile_64x65(	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
  input  [5:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [64:0] R0_data,
  ...
  reg [64:0] Memory[0:63];	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
    ...
    initial begin	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
        for (logic [6:0] i = 7'h0; i < 7'h40; i += 7'h1) begin
          ...
          Memory[i[5:0]] = _RANDOM_MEM[64:0];	// @[generators/boom/src/main/scala/v3/exu/register-read/regfile.scala:117:20]
        end
