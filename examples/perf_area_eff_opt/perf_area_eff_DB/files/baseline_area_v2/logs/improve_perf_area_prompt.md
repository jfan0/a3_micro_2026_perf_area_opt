...
**The parent design you are improving — branch `baseline_area_v1`:**

| metric | value |
|---|---|
| total cell area | 7,371,858 um2 |
| embench speed score | 88.077 |
| embench speed per MHz | 2.229238 |
| mean embench IPC | 1.449806 (reported, not the objective) |
| fmax | 39.51 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 11.947760 speed/mm2 |
