...
**The parent design you are improving — branch `baseline_area_v2`:**

| metric | value |
|---|---|
| total cell area | 6,738,322 um2 |
| embench speed score | 103.882 |
| embench speed per MHz | 2.229238 |
| mean embench IPC | 1.449806 (reported, not the objective) |
| fmax | 46.6 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 15.416671 speed/mm2 |
