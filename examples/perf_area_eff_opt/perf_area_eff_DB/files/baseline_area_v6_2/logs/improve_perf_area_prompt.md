...
**The parent design you are improving — branch `baseline_area_v5_1`:**

| metric | value |
|---|---|
| total cell area | 6,105,832 um2 |
| embench speed score | 104.915 |
| embench speed per MHz | 2.219955 |
| mean embench IPC | 1.444178 (reported, not the objective) |
| fmax | 47.26 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 17.182764 speed/mm2 |
