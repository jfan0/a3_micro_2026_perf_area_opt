...
module GenericSerializer_TLBeatw87_f32(	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
  ...
  wire        _GEN = io_out_ready & (|beat);	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:20:21, :23:{31,39}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
    if (_GEN & _io_out_bits_flit_T) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :22:39, :26:22, :28:25, :29:12, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  assign io_out_bits_flit = _io_out_bits_flit_T ? {30'h0, io_in_bits_head, io_in_bits_tail} : casez_tmp;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :22:39, :24:{26,52}]
endmodule
