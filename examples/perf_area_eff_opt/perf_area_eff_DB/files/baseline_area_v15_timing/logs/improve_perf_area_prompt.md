...
**The parent design you are improving — branch `baseline_area_v15`:**

| metric | value |
|---|---|
| total cell area | 4,999,074 um2 |
| embench speed score | 95.323 |
| embench speed per MHz | 2.192332 |
| mean embench IPC | 1.428116 (reported, not the objective) |
| fmax | 43.48 MHz (tt_025C_1v80) |
| perf_area_eff (speed/mm2) | 19.068051 speed/mm2 |

**The bar you have to clear is not that last row.** It is `20.571389 speed/mm2`, reached
by branch `v14` — the best figure any branch in the tree has measured,
and what the gate compares you against.

Usually `v14` *is* the parent and the two are the same number. When
...
| branch | built on | area mm2 | fmax MHz | IPC | speed/MHz | speed/mm2 | status | files this step touched |
|---|---|---|---|---|---|---|---|---|
| v15_1 | v14 | 5.065 | 39.81 | 1.428717 | 2.193479 | 17.239386 | gates_failed | functional-unit.scala |
| v15_timing | v15 | n/a | n/a | n/a | n/a | n/a | n/a | -- |
...
1. **`perf_area_eff` must exceed `20.571389 speed/mm2`** — the best any branch has
   measured (`v14`), not the parent's figure. Strictly exceed:
...
`parent_eff x (your ratio) > 20.571389 speed/mm2`, so work out that gap in percent first
...
The same three files for each of: v15_1_synth_only_flatten, v15_1, v15_synth_only_flatten, seed_synth_only_flatten, v14 — the most recent
...
### v15_1 (gates_failed, on v14) -- area -1.4%  cycles +0.0%  fmax -17.4%
...
index d2174d51..b91a5d5d 100644
