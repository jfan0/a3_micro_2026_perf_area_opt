...
module PhitDemux_p32_f32_n5_TestHarness_UNIQUIFIED(	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:183:7]
  ...
  reg         casez_tmp;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
  always @(*) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
    casez (channel_vec_0[2:0])	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:197:26, :198:37, :201:41]
      3'b000:
        casez_tmp = io_out_0_ready;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
      3'b001:
        casez_tmp = io_out_1_ready;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
      3'b010:
        casez_tmp = io_out_2_ready;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
      3'b011:
        casez_tmp = io_out_3_ready;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
      3'b100:
        casez_tmp = io_out_4_ready;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
      3'b101:
        casez_tmp = io_out_0_ready;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
      3'b110:
        casez_tmp = io_out_0_ready;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
      default:
        casez_tmp = io_out_0_ready;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41]
    endcase	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:197:26, :198:37, :201:41]
  end // always @(*)
  wire        io_in_ready_0 = ~beat | casez_tmp;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:196:23, :201:{25,41}]
  wire        _GEN = io_in_ready_0 & io_in_valid;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:201:41, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:183:7]
    ...
    if (_GEN & ~beat)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:196:23, :197:26, :201:25, :207:23, :209:35, :210:33, src/main/scala/chisel3/util/Decoupled.scala:51:35]
